...
TARGET_COLUMN = 'headcount_target_30min'
...
def build_features(
    ...
    30-minute-ahead occupancy model expects.
    ...
    pd.DataFrame, sorted by time, with columns:
        ...
        day_sin_future, day_cos_future, headcount_target_30min
    ...
    Rows are NOT dropped here:
      ...
      - the last HORIZON_STEPS rows have NaN 'headcount_target_30min'
